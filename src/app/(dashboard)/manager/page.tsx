            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-green-700">Ready for enrollment</p>
                </div>
              ...
              <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-purple-700">Across all courses</p>
                </div>
            ...
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="mb-6 max-w-md mx-auto">
                  Start by creating your first course. You can add lessons,
                  assignments, and track student progress all in one place.
                </p>
                <Link href="/manager/courses/create">
                  <Button size="lg">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Regularly update your course materials to maintain relevance
                    and engagement.
                  </p>
                </div>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Track student progress and provide feedback to improve
                    completion rates.
                  </p>
                </div>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Review reports to understand which content works best for
                    your students.
                  </p>
                </div>
              </div>
