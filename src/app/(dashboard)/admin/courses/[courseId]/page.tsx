      ...
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-white dark:bg-slate-900/50 dark:backdrop-blur-xl border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 border-b border-slate-100 dark:border-slate-800 mb-4 px-6 md:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="bg-white dark:bg-slate-900/50 dark:backdrop-blur-xl border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none">
            <CardHeader className="border-b border-slate-100 dark:border-slate-800 px-6 md:px-8">
