...
import { EnrollmentIntelligenceCard } from "@/components/admin/EnrollmentIntelligenceCard";
  ...
  return (
    ...
    >
      <div className="space-y-10 animate-fade-in pb-20">
        ...
        {/* Enrollment Intelligence — Courses + Career Paths (tabbed) */}
        <EnrollmentIntelligenceCard
          enrollments={(user.enrollments ?? []) as any}
          trackEnrollments={((user as any).trackEnrollments ?? []) as any}
        />
