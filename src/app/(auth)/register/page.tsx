...
export const metadata: Metadata = {
  ...
  description:
    "Create your Tech Hill account and start your computer literacy journey.",
};
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 dark:bg-[#080e1a] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-md w-full space-y-8">
        ...
        <RegisterForm className="w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-slate-200 dark:border-slate-800 shadow-xl" />
      </div>
    </div>
  );
}
