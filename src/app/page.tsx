...
import {
  BookOpen, Users, Award, Zap, Code2, BarChart2,
  CheckCircle2, ChevronRight, Play, Star, ArrowRight,
  Shield, Clock, Globe2
} from "lucide-react";
  ...
  return (
    <div className="group relative p-px rounded-2xl overflow-hidden bg-gradient-to-b from-slate-700/40 to-transparent hover:from-blue-500/30 transition-all duration-500">
      <div className="relative bg-slate-900/90 rounded-2xl p-7 h-full">
        <div className={`w-11 h-11 rounded-xl flex items-center justify-center mb-5 ${gradient}`}>
...
function CoursePreviewCard({
  title, tag, progress, color,
}: {
  title: string; tag: string; progress: number; color: string;
}) {
  return (
    ...
    <div className="dark min-h-screen bg-[#080e1a] text-white selection:bg-blue-500/30 antialiased">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up opacity-0 delay-200">
            Project-based courses built for Nigeria's next generation of engineers, designers, and digital professionals. Learn fast. Build real. Get hired.
          </p>
          ...
          <div className="flex items-center justify-center gap-4 animate-fade-in-up opacity-0 delay-500">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-slate-400">
                Loved by <span className="text-white font-semibold">10,000+</span> students across Nigeria
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="rounded-2xl overflow-hidden bg-[#0d1424]">
              ...
              <div className="flex items-center gap-2 px-4 h-10 border-b border-slate-800 bg-slate-900/50">
                ...
                <div className="flex-1 mx-4 h-5 bg-slate-800 rounded-md flex items-center px-3">
                  <span className="text-[11px] text-slate-500">techhill.io/student</span>
                </div>
              </div>
              ...
              <div className="p-6 grid grid-cols-12 gap-5">
                ...
                <div className="col-span-3 space-y-2 hidden md:block">
                  {["Dashboard", "My Courses", "Progress", "Certificates", "Settings"].map((item, i) => (
                    <div key={item} className={`h-8 rounded-lg flex items-center px-3 text-xs ${i === 1 ? "bg-blue-600/20 text-blue-400 font-semibold" : "text-slate-500"}`}>
                      {item}
                    </div>
                  ))}
                </div>
                ...
                <div className="col-span-12 md:col-span-9 space-y-4">
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { label: "Hours Learned", value: "48h", color: "text-blue-400" },
                      { label: "Courses Active", value: "3", color: "text-emerald-400" },
      ...
      <section className="border-y border-slate-800 py-10 bg-slate-900/40">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <StatPill value={`${(studentCount + 1000).toLocaleString()}+`} label="Active Students" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              <p className="text-sm font-semibold text-blue-400 uppercase tracking-widest mb-3">Portfolio Driven</p>
              <h2 className="text-4xl sm:text-5xl font-black text-white tracking-tight leading-tight">
                Stop watching <span className="gradient-text-blue">tutorials.</span><br />
                Start building <span className="gradient-text-blue">products.</span>
              </h2>
            </div>
            <p className="text-slate-400 max-w-sm text-right hidden md:block">
              Every course at Tech Hill is architected around a final, production-ready project that becomes the cornerstone of your portfolio.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={p.title} className="group relative flex flex-col bg-slate-900/50 border border-slate-800/60 rounded-3xl overflow-hidden hover:border-blue-500/30 transition-all duration-500">
                ...
                <div className="p-6">
                  <span className="text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-1.5 block">{p.category}</span>
                  ...
                  <Button variant="ghost" size="sm" className="w-full justify-between text-slate-400 group-hover:text-white group-hover:bg-slate-800 rounded-xl px-4 border border-transparent group-hover:border-slate-700 transition-all">
                    View Project Spec
      ...
      <section className="py-28 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <p className="text-sm font-semibold text-blue-400 uppercase tracking-widest mb-3">Why Tech Hill</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-5">
              Built for serious learners.
            </h2>
            <p className="text-slate-400 text-lg leading-relaxed">
              We cut the fluff. Every course is engineered around real, deployable projects — so your portfolio speaks before you do.
            </p>
          </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <blockquote className="text-2xl sm:text-3xl font-semibold text-white leading-relaxed mb-8">
            "Tech Hill took me from a JAMB student who could barely use Excel to a
            <span className="gradient-text-blue"> frontend engineer</span> earning
            <span className="gradient-text-blue"> ₦400k/month</span> remote — in 8 months."
          </blockquote>
          <div className="flex items-center justify-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm">A</div>
            <div className="text-left">
              <p className="text-white font-semibold text-sm">Amaka O.</p>
              <p className="text-slate-400 text-xs">Frontend Engineer, Flutterwave · Lagos</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          <p className="text-sm font-semibold text-blue-400 uppercase tracking-widest mb-4">Ready to start?</p>
          <h2 className="text-4xl sm:text-5xl font-black text-white tracking-tight mb-6">
            One decision that changes
            <br />your career trajectory.
          </h2>
          <p className="text-slate-400 text-lg mb-10 leading-relaxed">
            No hidden fees. No long-term contracts. Start with free courses and upgrade when you're ready.
          </p>
          ...
          <p className="text-slate-500 text-sm mt-6">Free forever. No credit card required.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 pb-12 border-b border-slate-800/80">
            ...
            <div className="col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="font-black text-xl text-white">Tech Hill<span className="text-blue-400">.</span></span>
              </div>
              <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
                Empowering the next generation of African tech talent with world-class education, real-world projects, and a thriving community.
              </p>
            </div>
