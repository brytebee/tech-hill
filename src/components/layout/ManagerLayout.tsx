        ...
        <div className="flex flex-col flex-grow bg-white dark:bg-[#080e1a] border-r border-slate-200 dark:border-slate-800 transition-colors duration-300">
          ...
          <div className="p-4 mt-auto border-t border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 px-2 py-2 mb-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-100 to-indigo-50 dark:from-blue-900/40 dark:to-indigo-900/20 flex items-center justify-center border border-blue-200 dark:border-blue-800/50 shadow-sm">
