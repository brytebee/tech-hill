...
export function QuestionForm({
  ...
  const form = useForm<QuestionFormData>({
    ...
    defaultValues: {
      ...
      questionType: (question?.questionType ||
        "MULTIPLE_CHOICE") as QuestionFormData["questionType"],
      points: question?.points || 1,
      explanation: question?.explanation || "",
      hint: question?.hint || "",
      difficulty: (question?.difficulty ||
        "MEDIUM") as QuestionFormData["difficulty"],
  ...
  const requiresOptions = QUESTION_TYPES.find(
    (type) => type.value === questionType
  )?.requiresOptions;
    ...
    try {
      ...
      const payload = {
        ...
        options: requiresOptions
          ? data.options?.filter((opt) => opt.text.trim())
          : undefined,
      };
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  onValueChange={(value) =>
                    form.setValue("questionType", value as any)
                  }
