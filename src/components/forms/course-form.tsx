...
const courseFormSchema = z.object({
  ...
  isCertificateFree: z.boolean(),
  certificatePrice: z.number().min(0).optional(),
      ...
      <CardContent>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="certificatePrice">Cert. Price (₦)</Label>
              <div className="flex flex-col gap-2">
                <Input
                  id="certificatePrice"
                  type="number"
                  disabled={form.watch("isCertificateFree")}
                  {...form.register("certificatePrice", {
                    valueAsNumber: true,
                  })}
                  placeholder="2000"
                  min="0"
                ...
                <div className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    id="isCertificateFree"
                    {...form.register("isCertificateFree")}
                    className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                  />
                  <Label
                    htmlFor="isCertificateFree"
