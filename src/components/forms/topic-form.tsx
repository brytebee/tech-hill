      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => onInputChange("isPreview", checked)}
          />
          <Label htmlFor="isPreview" className="flex flex-col">
            <span>Free Preview</span>
            <span className="text-xs font-normal text-muted-foreground">
              Allows students to view this lesson without enrolling or paying
              for the course
            </span>
          </Label>
        </div>
